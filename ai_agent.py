...
KNOWLEDGE_CHUNKS = [
    ...
    {
        "id": "certificates",
        "keywords": ["certificate", "certificates", "certification", "certifications", "nvidia", "deep learning", "rag", "transformers", "nlp", "cybersecurity", "prompt engineering", "credentials", "credential", "kaggle", "datacamp", "python", "computer vision", "reinforcement learning", "game ai"],
        "text": "NVIDIA Certificates: Building RAG Agents, Transformers, Prompt Engineering, Cybersecurity, Deep Learning, Diffusion Models, Real-Time Video AI, CUDA Python. DataCamp Certificates: Data Analyst Associate, Data Engineer Associate, Data Literacy. Kaggle Certificates: Python, Computer Vision, Intro to Game AI and Reinforcement Learning.",
        "twin": "🤖 **[Anis-AI]:** Anis has earned credentials from **NVIDIA, DataCamp, and Kaggle**!\n\n🎖 **NVIDIA Certificates of Competency:**\n1. 🧠 **Building RAG Agents with LLMs**\n2. 📝 **Introduction to Transformer-Based Natural Language Processing**\n3. ⚙️ **Building LLM Applications With Prompt Engineering**\n4. 🛡️ **Building AI-Based Cybersecurity Pipelines**\n5. 🚀 **Fundamentals of Deep Learning**\n6. 🎨 **Generative AI with Diffusion Models**\n7. 📹 **Building Real-Time Video AI Applications**\n8. 🐍 **Fundamentals of Accelerated Computing with CUDA Python**\n\n📊 **DataCamp Certifications:**\n1. 📈 **Data Analyst Associate**\n2. 🛠 **Data Engineer Associate**\n3. 💡 **Data Literacy**\n\n🎯 **Kaggle Certifications:**\n1. 🐍 **Python**\n2. 👁 **Computer Vision**\n3. 🎮 **Intro to Game AI and Reinforcement Learning**\n\nYou can view and verify all of them in the Certificates section on this site!",
        "recruiter": "💼 **[Anis-Recruiter]:** Anis holds verified credentials across three tier-1 platforms: **NVIDIA** (8 Certificates of Competency in Deep Learning, NLP, Prompt Engineering, Cybersecurity, RAG, Diffusion Models, Video AI, and CUDA), **DataCamp** (Data Analyst Associate, Data Engineer Associate, and Data Literacy), and **Kaggle** (Python, Computer Vision, and Game AI & Reinforcement Learning). These demonstrate robust proficiency in machine learning and data engineering workflows.",
        "tech": "💻 **[Anis-Tech]:** Verified Credentials Registry:\n- **NVIDIA:** RAG Agents (`7vo8r-_oQv2bJTyHff6CDQ`), Transformers (`Yy6SLV7eT4eN7Ll-txHLBQ`), Prompt Eng (`iagFYqO4QJmdv4JJU6g_sw`), Cybersecurity (`As48ycFRRMqT0VKVb4PbtA`), Deep Learning (`4C-6f4fjSHK2HcgQfx6_ZA`), Diffusion (`fn3bEZHDTHCZATWKG-svvg`), Video AI (`DttLN2ikRJeNMkkh7euKHA`), CUDA (`t-mYwSVhRC2Ve6K0z1qflQ`).\n- **DataCamp:** Data Analyst (`DAA0017212894806`), Data Engineer (`DEA0011654537731`), Data Literacy (`DL0035526229636`).\n- **Kaggle:** Python (`mselmianis/python`), Computer Vision (`mselmianis/computer-vision`), Intro to Game AI and Reinforcement Learning (`mselmianis/intro-to-game-ai-and-reinforcement-learning`)."
    }
]
